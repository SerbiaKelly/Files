...
function this.OnEnter()
    ...
    msg.type = proxy_pb.USER_INVITATION
	local body = proxy_pb.PUserInvitation()
	body.inviterId = strNum
	msg.body = body:SerializeToString()
	SendProxyMessage(msg, this.OnGetUserInvitation)
end
function this.Update()
   
end
function this.OnGetUserInvitation(msg)
	PanelManager.Instance:HideWindow(gameObject.name)
