...
panelStageClearAll_hnzzm = {}
local this = panelStageClearAll_hnzzm
...
--	四人
	...
	for i = 1, 4 do
		...
		playerSize4[i].MinggangCount 	= playerSize4[i].transform:Find("ScoreGroup/grid/MinggangCount");
		playerSize4[i].AnganggangCount 	= playerSize4[i].transform:Find("ScoreGroup/grid/AnganggangCount");
...
--	三人和二人
	for i = 1, 3 do
		...
		playerSize3and2[i].MinggangCount 	= playerSize3and2[i].transform:Find("ScoreGroup/grid/MinggangCount");
		playerSize3and2[i].AnganggangCount 	= playerSize3and2[i].transform:Find("ScoreGroup/grid/AnganggangCount");
...
function this.OnClickMask(go)
	...
	PanelManager.Instance:HideWindow('panelInGame_hnzzm');
...
function this.SetPlayerInfo(playerObj,playerData)
	...
	--10.接炮次数
	playerObj.JiepaoCount:GetComponent("UILabel").text 		= "接炮次数："..playerData.jiePao;
	--11.点炮次数
	playerObj.DianpaoCount:GetComponent("UILabel").text 	= "点炮次数："..playerData.dianPao;
	--12.明杠
	playerObj.MinggangCount:GetComponent("UILabel").text 	= "明杠次数："..playerData.mingGang;
	--13.暗杠
	playerObj.AnganggangCount:GetComponent("UILabel").text 	= "暗杠次数："..playerData.anGang;
	--14.积分
