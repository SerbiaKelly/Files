...
function this.Awake( go )
    -- body
    print("panelReplay_hnzzm.Awake was called");
    gameObject = go;
...
function this.WhoShow( data )
    ...
    RePlayLogic = HNZZM_RePlayLogic.New(panelReplay_hnzzm,hnm_pb,proxy_pb.HNM,gameObject);
