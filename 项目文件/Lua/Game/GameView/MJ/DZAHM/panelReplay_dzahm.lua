...
function this.Awake( go )
    -- body
    print("panelReplay_dzahm.Awake was called");
    gameObject = go;
...
function this.WhoShow( data )
	...
	b.gameType  = proxy_pb.DZM;
    msg.type    = proxy_pb.ROUND_RECORDS;
    msg.body    = b:SerializeToString()
    RePlayLogic = DZAHM_RePlayLogic.New(panelReplay_dzahm,dzm_pb,proxy_pb.DZM,gameObject);
...
function this.OnGetRoundDetail(msg)
    ...
    local RoundDetail = dzm_pb.RRoundRecords();
