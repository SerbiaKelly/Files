...
panelGameSetting_hnhsm = {}
local this = panelGameSetting_hnhsm;
...
function this.SetPresetting()
    ...
    local cardColor = UnityEngine.PlayerPrefs.GetInt('cardColor_hnhsm', 1);
    local cardText  = UnityEngine.PlayerPrefs.GetInt('cardText_hnhsm', 1);
    local language  = UnityEngine.PlayerPrefs.GetInt('language_hnhsm', 1);
    local outPlateType  = UnityEngine.PlayerPrefs.GetInt('outPlateType_hnhsm', 0);
...
function this.OnCardColorClick(obj)
    ...
    UnityEngine.PlayerPrefs.SetInt('cardColor_hnhsm', tonumber(obj.name));
end
...
function this.OnCardTextClick(obj)
    ...
    if obj == toggleNormalPlate.gameObject then 
        ...
        UnityEngine.PlayerPrefs.SetInt('cardText_hnhsm', 2);
    elseif obj == toggleSuperPlate.gameObject then 
        print("path--------->2")
        panelInGame.SetCardText(1);
        UnityEngine.PlayerPrefs.SetInt('cardText_hnhsm', 1);
    end
...
function this.OnClickLanguage(go)
    if go == toggleNormalLanguage.gameObject then 
        ...
        UnityEngine.PlayerPrefs.SetInt('language_hnhsm', 1);
    elseif go == toggleLocalLanguage.gameObject then 
        panelInGame.SetLanguage(2);
        UnityEngine.PlayerPrefs.SetInt('language_hnhsm', 2);
    end
...
function this.OnBGColorClick(obj)
    ...
    UnityEngine.PlayerPrefs.SetInt('bgColor_hnhsm', tonumber(obj.name));
end
...
function this.ClickShowRule()
	--AudioManager.Instance:PlayAudio('btn')
	local playString = '划水麻将';
	WanFaLab.text = playString;
	RuleLab.text= GetHNHSMRuleText(roomData.setting,false);
end
...
function this.OnClickOutPlateType()
    ...
    if outPlateTypeToggle:GetComponent("UIToggle").value then 
        UnityEngine.PlayerPrefs.SetInt('outPlateType_hnhsm', 1);
        panelInGame.SetOutPlateType(1);
    else
        UnityEngine.PlayerPrefs.SetInt('outPlateType_hnhsm', 0);
