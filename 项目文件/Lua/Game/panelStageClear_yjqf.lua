...
panelStageClear_yjqf = {}
local this = panelStageClear_yjqf
...
function this.Awake(obj)
	...
	for i = 0,play.childCount - 1 do
		...
		playerUI.playerHistoryScore = playerUI.obj:Find('historyScore')
		playerUI.playerXiScore = playerUI.obj:Find('xiScore')
		playerUI.playerRewardScore = playerUI.obj:Find('rewardScore')
...
function this.OnEnable()
	RegisterGameCallBack(yjqf_pb.SHUFFLE, this.onGetXiPaiResult)
...
function this.Refresh()
	roundNum:GetComponent("UILabel").text = '第'..roomData.round..'局'
