...
require("HNHSM_UILayer");
require("FsmMachine");
require("HNHSM_PlayLogic");
local json          = require("json");
local hnm_pb        = nil;
HNHSM_Logic         = {};
HNHSM_Logic         = class(GameLogic);
local this          = nil;
local message       = nil;
...
function HNHSM_Logic:ctor(gameView, game_pb, gameType, obj)
    this = self;
    hnm_pb = game_pb;
    uiLayer = HNHSM_UILayer.New(obj,this,hnm_pb);
...
function HNHSM_Logic:InitStateMachine()

end

function HNHSM_Logic:GetUILayer()
    return uiLayer;
end


function HNHSM_Logic:RegisterGameCallBack()
...
function HNHSM_Logic:GetMaxPlayerSize()
    return c_MaxSize;
end
...
function HNHSM_Logic:GetCorrectUIIndex(index)
...
function HNHSM_Logic:GetPlayerViewBySeat(seat)
...
--玩家摸牌
function HNHSM_Logic:OnPlayerMoPai(msg)
...
--玩家出牌
function HNHSM_Logic:OnPlayerChuPai(msg)
...
--玩家吃牌
function HNHSM_Logic:OnPlayerChiPai(msg)
...
--玩家碰牌
function HNHSM_Logic:OnPlayerPengPai(msg)
...
--玩家杠牌
function HNHSM_Logic:OnPlayerGangPai(msg)
...
--玩家补牌(呼市麻将没有补的操作)
function HNHSM_Logic:OnPlayerBuPai(msg)
...
function HNHSM_Logic:CanChuPai()
...
--玩家过牌
function HNHSM_Logic:OnPlayerGuoPai(msg)
...
--玩家胡牌
function HNHSM_Logic:OnPlayerHuPai(msg)
...
--获得想要解散房间的玩家信息
function HNHSM_Logic:GetDissolutions()
    local dissolution       = {}
...
function HNHSM_Logic:AutoRegisterPlayerDatas(playerDatas,resetView)
    self.super.AutoRegisterPlayerDatas(self,playerDatas,resetView);
end

--检查用户数据
function HNHSM_Logic:CheckPlayerDatas(playerData)
...
--开局倒计时自动解散的
function HNHSM_Logic:CheckAutoDissolutionState()

end

function HNHSM_Logic:OnJoinRoom(data)
...
--玩家加入
function HNHSM_Logic:OnPlayerJoin(data)
    -- print("-----------------OnPlayerJoin---------------")
...
function HNHSM_Logic:OnLeaveRoom()
    --print("-----------------OnLeaveRoom-----------------")
...
function HNHSM_Logic:OnInitView(data)
...
function HNHSM_Logic:OnPlayerLeave(seat)
    print("座位号："..seat.."玩家，离开房间")
    uiLayer:RefreshGpsView();
end


function HNHSM_Logic:OnLordDissolve()
...
function HNHSM_Logic:OnGameRoundStart(data)
...
function HNHSM_Logic:OnGameRoundEnd(data)
...
--清除一些游戏状态
function HNHSM_Logic:ClearGameStates()
    --1.清除准备状态
...
function HNHSM_Logic:GetCorrectRound()
...
function HNHSM_Logic:OnGameRoundOver(data)
...
function HNHSM_Logic:OnGameDestroy(data)
    -- print("-----------------OnGameDestroy-----------------")
...
function HNHSM_Logic:OnDissolve(data)
    uiLayer:SetDissolve(data);
    -- DelayMsgDispatch(self.connect,0.5);
end

function HNHSM_Logic:RestoreGameScene()
    uiLayer:RefreshAllUI();
end

function HNHSM_Logic:ResetRoundStartState()
...
function HNHSM_Logic:ResetGameState()
    self:ForeachPlayerDatas(function(playerView,_) playerView:ResetGameState() end)
end


function HNHSM_Logic:ChangePaiSize(hnhsmPaiSize)
    self.hnhsmPaiSize = hnhsmPaiSize;
    uiLayer:ChangePaiSize(hnhsmPaiSize);
end

function HNHSM_Logic:IsGaming(logic, roomData)
    return logic:IsAllReaded() or not IsGameReadState(self.roomData) or self.roomData.round > 1
end

function HNHSM_Logic:IsAllSquatPullRuned()
    local isAllSPR = true;
    self:ForeachPlayerDatas(function(playerView,playerData) 
...
function HNHSM_Logic:GetDefaultSurplus()
    return self.roomData.setting.playStorm and 144 or 116;
end

--刷新庄家位置
function HNHSM_Logic:OnRefreshBanker(msg)
...
function HNHSM_Logic:OnPlayerTrustesship(seat,enable)
...
--游戏错误，主要是申请5次
function HNHSM_Logic:OnGameError(msg)
    -- print("OnGameError------------------------>");
...
--房间不存在
function HNHSM_Logic:OnRoomNoExist()
    uiLayer:SetRoomNoExist();
end

--房间在规定时间没有开始，自动解散
function HNHSM_Logic:OnRoomDissolveIn5Seconds()
