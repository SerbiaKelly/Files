...
function this.Init(grid,message)
	...
	pkhsthObj.ToggleMasterPay = PKHSTH:Find('table/pay/master')
	pkhsthObj.ToggleWinnerPay = PKHSTH:Find('table/pay/win')
	message:AddClick(pkhsthObj.ToggleMasterPay.gameObject, this.OnClickTogglePayType)
	message:AddClick(pkhsthObj.ToggleWinnerPay.gameObject, this.OnClickTogglePayType)
...
function this.Refresh()
	print('Refresh_PKHSTH')
	pkhsthData.rounds=UnityEngine.PlayerPrefs.GetInt('NewPKHSTHrounds', 1)
	...
	pkhsthData.size=UnityEngine.PlayerPrefs.GetInt('NewPKHSTHsize', 2)
	...
	pkhsthData.paymentType=UnityEngine.PlayerPrefs.GetInt('NewPKHSTHpaymentType', 0)
	pkhsthObj.ToggleMasterPay:GetComponent('UIToggle'):Set(pkhsthData.paymentType == 0)
	pkhsthObj.ToggleWinnerPay:GetComponent('UIToggle'):Set(pkhsthData.paymentType == 2)

	pkhsthData.cardCount=UnityEngine.PlayerPrefs.GetInt('NewPKHSTHcardCount', 0)
	...
	pkhsthData.sinkKill=UnityEngine.PlayerPrefs.GetInt('NewPKHSTHsinkKill', 1)
	...
	pkhsthData.settlement=UnityEngine.PlayerPrefs.GetInt('NewPKHSTHsettlement', 2)
	...
	pkhsthData.tong=UnityEngine.PlayerPrefs.GetInt('NewPKHSTHtong', 1)
	...
	pkhsthData.showCards=UnityEngine.PlayerPrefs.GetInt('NewPKHSTHshowCards', 1)==1
	pkhsthObj.ToggleShowCardNum:GetComponent('UIToggle'):Set(pkhsthData.showCards)
	pkhsthData.tongSplit=UnityEngine.PlayerPrefs.GetInt('NewPKHSTHtongSplit', 1)==1
	pkhsthObj.ToggleTongSplit:GetComponent('UIToggle'):Set(pkhsthData.tongSplit)
	pkhsthData.removeRank=UnityEngine.PlayerPrefs.GetInt('NewPKHSTHremoveRank', 1)==1
	pkhsthObj.ToggleRemoveRank:GetComponent('UIToggle'):Set(pkhsthData.removeRank)
	pkhsthData.teamVoice=UnityEngine.PlayerPrefs.GetInt('NewPKHSTHteamVoice', 1)==1
	pkhsthObj.ToggleFriendVoice:GetComponent('UIToggle'):Set(pkhsthData.teamVoice)

	pkhsthData.lastBonus=UnityEngine.PlayerPrefs.GetInt('NewPKHSTHlastBonus', 0)
	...
	pkhsthData.grouping=UnityEngine.PlayerPrefs.GetInt('NewPKHSTHgrouping', 1)
	...
	pkhsthData.choiceDouble=UnityEngine.PlayerPrefs.GetInt('NewPKHSTHchoiceDouble', 0)==1
	pkhsthData.doubleScore=UnityEngine.PlayerPrefs.GetInt('NewPKHSTHdoubleScore', 100)
	pkhsthData.multiple=UnityEngine.PlayerPrefs.GetInt('NewPKHSTHmultiple', 2)
	...
	pkhsthData.isSettlementScore=UnityEngine.PlayerPrefs.GetInt('NewPKHSTHisSettlementScore', 0)==1
	pkhsthData.fewerValue=UnityEngine.PlayerPrefs.GetInt('NewPKHSTHfewerValue', 10)
	pkhsthData.addValue=UnityEngine.PlayerPrefs.GetInt('NewPKHSTHaddValue', 10)
	...
	pkhsthData.trusteeshipTime=UnityEngine.PlayerPrefs.GetInt('NewPKHSTHtrusteeshipTime', 0)
	pkhsthData.trusteeshipType = UnityEngine.PlayerPrefs.GetInt('NewPKHSTHtrusteeshipType', 0) == 1
	pkhsthData.trusteeshipRound = UnityEngine.PlayerPrefs.GetInt('NewPKHSTHtrusteeshipRound', 0)
	...
	pkhsthData.openIp=UnityEngine.PlayerPrefs.GetInt('PKHSTHcheckIP', 0)==1
	pkhsthData.openGps=UnityEngine.PlayerPrefs.GetInt('PKHSTHcheckGPS', 0)==1
	...
	payLabel:GetComponent("UILabel").text = GetPayMun(proxy_pb.PKHSTH,nil,pkhsthData.size,nil)
...
function this.GetConfig()
    ...
    local body = {}
	body.roomType = UnityEngine.PlayerPrefs.GetInt('createRoomType', proxy_pb.PKHSTH)
	body.rounds = pkhsthData.rounds
    body.size = pkhsthData.size
	body.paymentType = pkhsthData.paymentType
	local cardCount = 10
...
function this.OnClickToggleRound(go)
    ...
    UnityEngine.PlayerPrefs.SetInt('NewPKHSTHrounds', pkhsthData.rounds)
end
...
function this.OnClickTogglePlayerNum(go)
	...
	pkhsthObj.ToggleSettlementScoreSelect.parent.gameObject:SetActive(pkhsthData.size==2)
	pkhsthObj.ToggleIPcheck.parent.gameObject:SetActive(pkhsthData.size > 2 and CONST.IPcheckOn)
	UnityEngine.PlayerPrefs.SetInt('NewPKHSTHsize', pkhsthData.size)
    PKHSTH:Find('table'):GetComponent('UIGrid'):Reposition()
end

function this.OnClickTogglePayType(go)
    AudioManager.Instance:PlayAudio('btn')
    if pkhsthObj.ToggleMasterPay.gameObject == go then
        pkhsthData.paymentType=0
    elseif pkhsthObj.ToggleWinnerPay.gameObject == go then
        pkhsthData.paymentType=2
    end
    UnityEngine.PlayerPrefs.SetInt('NewPKHSTHpaymentType', pkhsthData.paymentType)
end

function this.OnClickToggleCardCount(go)
	AudioManager.Instance:PlayAudio('btn')
	pkhsthData.cardCount = tonumber(go.name)
	UnityEngine.PlayerPrefs.SetInt('NewPKHSTHcardCount', pkhsthData.cardCount)
end

function this.OnClickToggleSinkKill(go)
	AudioManager.Instance:PlayAudio('btn')
	pkhsthData.sinkKill = tonumber(go.name)
	UnityEngine.PlayerPrefs.SetInt('NewPKHSTHsinkKill', pkhsthData.sinkKill)
end
function this.OnClickToggleSettlement(go)
	AudioManager.Instance:PlayAudio('btn')
	pkhsthData.settlement = tonumber(go.name)
	UnityEngine.PlayerPrefs.SetInt('NewPKHSTHsettlement', pkhsthData.settlement)
end
function this.OnClickToggleTongHua(go)
	...
	print('pkhsthData.tong :'..pkhsthData.tong)
	UnityEngine.PlayerPrefs.SetInt('NewPKHSTHtong', pkhsthData.tong)
end
...
function this.OnClickTogglePlay(go)
	...
	if pkhsthObj.ToggleShowCardNum.gameObject == go then
		...
		UnityEngine.PlayerPrefs.SetInt('NewPKHSTHshowCards', pkhsthData.showCards and 1 or 0)
	elseif pkhsthObj.ToggleTongSplit.gameObject == go then
		...
		UnityEngine.PlayerPrefs.SetInt('NewPKHSTHtongSplit', pkhsthData.tongSplit and 1 or 0)
	elseif pkhsthObj.ToggleRemoveRank.gameObject == go then
		...
		UnityEngine.PlayerPrefs.SetInt('NewPKHSTHremoveRank', pkhsthData.removeRank and 1 or 0)
	elseif pkhsthObj.ToggleFriendVoice.gameObject == go then
		...
		UnityEngine.PlayerPrefs.SetInt('NewPKHSTHteamVoice', pkhsthData.teamVoice and 1 or 0)
	end
end
...
function this.OnClickChangeRewardScoreValue(go)
    ...
    UnityEngine.PlayerPrefs.SetInt('NewPKHSTHlastBonus', pkhsthData.lastBonus)
end

function this.OnClickToggleGrouping(go)
	AudioManager.Instance:PlayAudio('btn')
	pkhsthData.grouping = tonumber(go.name)
	UnityEngine.PlayerPrefs.SetInt('NewPKHSTHgrouping', pkhsthData.grouping)
end
...
function this.OnClickChoiceDouble(go)
    ...
    PKHSTH:Find('table'):GetComponent('UIGrid'):Reposition()
    UnityEngine.PlayerPrefs.SetInt('NewPKHSTHchoiceDouble', pkhsthData.choiceDouble and 1 or 0)
end
...
function this.OnClickChangeDoubleScore(go)
    ...
    UnityEngine.PlayerPrefs.SetInt('NewPKHSTHdoubleScore', pkhsthData.doubleScore)
end
...
function this.OnClickMultiple(go)
    ...
    UnityEngine.PlayerPrefs.SetInt('NewPKHSTHmultiple', pkhsthData.multiple)
end
...
function this.OnClickSettlementScoreSelect(go)
    ...
    UnityEngine.PlayerPrefs.SetInt('NewPKHSTHisSettlementScore', pkhsthData.isSettlementScore and 1 or 0)
end
...
function this.OnClickFewerButton(go)
	...
	pkhsthObj.ToggleFewerScoreTxt:GetComponent('UILabel').text = pkhsthData.fewerValue
	UnityEngine.PlayerPrefs.SetInt('NewPKHSTHfewerValue', pkhsthData.fewerValue)
end
...
function this.OnClickAddButton(go)
	...
	pkhsthObj.ToggleAddScoreTxt:GetComponent('UILabel').text = pkhsthData.addValue
	UnityEngine.PlayerPrefs.SetInt('NewPKHSTHaddValue', pkhsthData.addValue)
end
...
function this.OnClickTrusteeshipTime(go)
    ...
    UnityEngine.PlayerPrefs.SetInt('NewPKHSTHtrusteeshipTime', pkhsthData.trusteeshipTime)
	pkhsthObj.ToggleTrusteeshipOne.parent.gameObject:SetActive(pkhsthData.trusteeshipTime ~= 0)
	PKHSTH:Find('table'):GetComponent('UIGrid'):Reposition()
end
...
function this.OnClickTrusteeshipType(go)
    ...
    UnityEngine.PlayerPrefs.SetInt('NewPKHSTHtrusteeshipType',pkhsthData.trusteeshipType and 1 or 0)
    UnityEngine.PlayerPrefs.SetInt('NewPKHSTHtrusteeshipRound',pkhsthData.trusteeshipRound )
end
...
function this.OnClickPreventCheat(go)
	...
	if pkhsthObj.ToggleIPcheck.gameObject == go then
		...
		UnityEngine.PlayerPrefs.SetInt('PKHSTHcheckIP', pkhsthData.openIp and 1 or 0)
	elseif pkhsthObj.ToggleGPScheck.gameObject == go then
		...
		UnityEngine.PlayerPrefs.SetInt('PKHSTHcheckGPS', pkhsthData.openGps and 1 or 0)
	end
end
